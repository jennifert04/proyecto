#llamar librerias
from dash import Dash, html, dcc #libreria para servidor web de dara science(dash manipular servidores web con phyton, html emular 
#configurar objetos html, dcc visualizar cosas bonitas )
...
app = Dash(__name__) #creé un objeto dash
...
app.layout = html.Div([html.H1('Programa para el covid en AMVA'),
                        html.Div('Información de la pagina'),
...
if __name__ == '__main__':
    ...
    app.run_server(host='0.0.0.0',port=80) #servidor en memoria ram que se pegó a ese puerto
